...
const NINEBOT_BOXJS_JSON_URL =
  "https://raw.githubusercontent.com/Jason6111/QYR-/jiuhao/2.9.boxjs.json"

const NINEBOT_BOXJS_SUB_URL =
  `http://boxjs.com/#/sub/add/${encodeURIComponent(NINEBOT_BOXJS_JSON_URL)}`

const NINEBOT_LOON_PLUGIN_URL =
  "https://raw.githubusercontent.com/Jason6111/QYR-/jiuhao/NinebotSign2.9.plugin"
...
function AboutView() {
  ...
  const openGithub = async () => {
    try {
      await Safari.openURL("https://github.com/Jason6111/QYR-/tree/jiuhao")
    } catch (error) {
      await Pasteboard.setString("https://github.com/Jason6111/QYR-/tree/jiuhao")
      await Dialog.alert({
        title: "已复制链接",
